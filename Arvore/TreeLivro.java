...
public class TreeLivro {
    ...
    //INSERIR UM LIVRO NA ARVORE
    public void inserir(Livro v) {
      No novo = new No(); // cria um novo Nó
      novo.itemLivro = v; // atribui o valor recebido ao item de dados do Nó
      novo.dir = null;
      novo.esq = null;
      ...
      if (root == null)
        ...
        while (true) {
          anterior = atual;
          if (v.getCodigIdentificacao() <= atual.itemLivro.getCodigIdentificacao()) { // ir para esquerda
            atual = atual.esq;
            if (atual == null) {
              anterior.esq = novo;
              return;
    ...
    public Livro buscar(int chave) {
      ...
      while (atual.itemLivro.getCodigIdentificacao() != chave) { // enquanto nao encontrou
        if (chave < atual.itemLivro.getCodigIdentificacao())
      ...
      return atual.itemLivro; // terminou o laço while e chegou aqui é pq encontrou item
    }
    ...
    public boolean remover(int chave) {
      ...
      while (atual.itemLivro.getCodigIdentificacao() != chave) { // enquanto nao encontrou
        pai = atual;
        if (chave < atual.itemLivro.getCodigIdentificacao()) { // caminha para esquerda
          atual = atual.esq;
    ...
    public void inOrder(No atual) {
      if (atual != null) {
        inOrder(atual.esq);
        System.out.print(atual.itemLivro + " ");
        inOrder(atual.dir);
      }
    }
